...
/** Mounts the section and hands back its picker and the text the user can read. */
async function open(): Promise<[HTMLSelectElement, () => string]> {
  ...
  return [host.querySelector('select')!, text];
}
