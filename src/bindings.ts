...
export const commands = {
	...
	pdmxStatus: () => __TAURI_INVOKE<PdmxStatus>("pdmx_status"),
	/**
	 ...
	 */
	pdmxFetch: () => __TAURI_INVOKE<PdmxStatus>("pdmx_fetch"),
	 ...
	 */
	updateCheck: () => __TAURI_INVOKE<UpdateStatus>("update_check"),
	/**
	 ...
	 */
	updateInstall: () => __TAURI_INVOKE<UpdateStatus>("update_install"),
	/**
...
export const events = {
	...
	pdmxDone: makeEvent<PdmxDone>("pdmx-done"),
	pdmxProgress: makeEvent<PdmxProgress>("pdmx-progress"),
	previewProgress: makeEvent<PreviewProgress>("preview-progress"),
	updateDone: makeEvent<UpdateDone>("update-done"),
...
export type PdmxDone = PdmxStatus;
...
export type UpdateDone = UpdateStatus;
