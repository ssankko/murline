...
/** The curve every boot-screen movement rides: the `--ease` of src/index.css, which Web Animations options cannot name. */
export const EASE_CURVE = 'cubic-bezier(0.65, 0, 0.35, 1)';

/**
 * The prefix of `lines` the log shows, one line longer per beat, and whether every line has
 * appeared. The first line skips its beat: index.html paints it before React mounts, so it is
 * already on screen.
 */
